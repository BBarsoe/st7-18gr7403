...
trainLabelVec = (Data_table.sleep(1:12000));
trainSamples = table2array(Data_table(1:12000,1:16));
testLabelVec = Data_table.sleep(12001:end);
testSamples = table2array(Data_table(12001:end,1:16));
%% Classify

...
%% Make a table
featuresData = table(heartData.timestamp(1:end-2),heartData.value(1:end-2),heart_diff(1:end-1), heart_diff_movmax(1:end-1),heart_diff_movmean(1:end-1),heart_diff_movmin(1:end-1),...
    ...
    stepsData.value(1:end-2),steps_diff(1:end-1),...
    ...
    isSleepingData.value(1:end-2),sleepingAverageData.value(1:end-2),...
    ...
    step_movmean_1m_delay_5m(1:end-2),step_movmean_5m_delay_15m(1:end-2),step_movmean_15m_delay_1h(1:end-2),step_movmean_2h_delay_5h(1:end-2),fluidModelResult.value(1:end-2),...

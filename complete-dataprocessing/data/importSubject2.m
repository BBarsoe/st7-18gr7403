function [rawSteps, rawHeart, rawSleep, rawFluid, rawHeadache] = importSubject2()
%% Load data
if isfile("data/rawDataSubject2.mat")
    load("data/rawDataSubject2.mat");
else
    rawData = importfile('data/subject2.xlsx');
    ...
    clear rawData;
    save('data/rawDataSubject2.mat','rawSteps','rawHeart','rawSleep','rawFluid','rawHeadache');
end
end